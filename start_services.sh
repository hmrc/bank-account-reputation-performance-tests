...
sm2 --start BANK_ACCOUNT_REPUTATION_FRONTEND_SERVICES BANK_ACCOUNT_REPUTATION_THIRD_PARTIES_STUB --appendArgs '{
  "BANK_ACCOUNT_REPUTATION": [
    ...
    "-Dmicroservice.services.access-control.endpoint.verify.allow-list.1=bars-performance-tests",
    "-Dmicroservice.services.access-control.endpoint.verify.allow-list.2=some-upstream-service",
    "-Dmicroservice.services.access-control.endpoint.verify.allow-list.3=bank-account-reputation-frontend",
    "-Dmicroservice.services.access-control.endpoint.verify.allow-list.4=bank-account-verification-frontend",
    ...
    "-Dmicroservice.services.access-control.endpoint.validate.allow-list.1=bars-performance-tests",
    "-Dmicroservice.services.access-control.endpoint.validate.allow-list.2=some-upstream-service",
    "-Dmicroservice.services.access-control.endpoint.validate.allow-list.3=bank-account-reputation-frontend",
    "-Dmicroservice.services.access-control.endpoint.validate.allow-list.4=bank-account-verification-frontend",
